              ...
              <a href={project.github} target="_blank" rel="noopener noreferrer" className="proj-lightbox-link">
                {project.github.includes('gitlab.com') ? (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M22.65 14.39L20.3 7.24a.43.43 0 00-.81 0L17.14 14.4H6.86L4.51 7.24a.43.43 0 00-.81 0L1.35 14.39a.85.85 0 00.31.95l10.09 7.33a.43.43 0 00.5 0l10.09-7.33a.85.85 0 00.31-.95z"/>
                  </svg>
                ) : (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                ...
                {project.github.includes('gitlab.com') ? 'GitLab' : 'GitHub'}
              </a>
            )}
            {project.demo && (
...
export const Projects: React.FC<ProjectsProps> = ({ isActive }) => {
  ...
  const projects: ProjectData[] = [
    ...
    },
    {
      ...
      tag: 'Plataforma Educativa · Full Stack',
      stack: ['React', 'NestJS', 'SQLite'],
      description: 'Plataforma educativa con juegos de aprendizaje para niños de 1er a 3er grado.',
      thumbnail: '/projects/aprendejugando.webp',
      screenshots: [
        '/projects/aprendejugando.webp',
        '/projects/pantallamenu.webp',
        '/projects/juegos.webp',
        '/projects/juegolaberinto.webp',
        '/projects/pantallavictoria.webp',
        '/projects/simondice.webp',
      ],
      github: 'https://gitlab.com/diamondmiguel12/learning-playing-platform',
      demo: 'https://aprende-jugando.onrender.com/',
    },
  ];
