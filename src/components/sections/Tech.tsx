...
export const Tech: React.FC<TechProps> = ({ isActive }) => {
  ...
  return (
    <div className="panel">
      <DiamondBackground variant={2} />
      <div className="panel-inner tech-panel-inner">
        <h3 className={`section-label ${revealClass}`}>02 · Tecnologías</h3>
        <h2 className={`section-title ${revealClass}`}>
          Stack afilado al extremo
        </h2>

        <div className={`tech-dashboard ${revealClass}`}>
          {/* Column 1: Lenguajes */}
          <div className="tech-stack-column">
            <h4 className="tech-stack-header">Lenguajes</h4>
            <div className="tech-grid">
              {/* PHP */}
              <div className="tech-card">
                <div className="tech-icon-box box-php">
                  <svg
                    className="tech-svg"
              ...
              {/* Javascript */}
              <div className="tech-card">
                <div className="tech-icon-box box-js">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 128 128"
              ...
              {/* TypeScript */}
              <div className="tech-card">
                <div className="tech-icon-box box-ts">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                  >
                    <rect width="24" height="24" rx="1.125" fill="#fff" />
                    <path
                      fill="#3178c6"
          ...
          {/* Column 2: Frontend */}
          <div className="tech-stack-column">
            <h4 className="tech-stack-header">Frontend</h4>
            <div className="tech-grid">
              {/* React */}
              <div className="tech-card">
                <div className="tech-icon-box box-react">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 128 128"
              ...
              {/* Next.js */}
              <div className="tech-card">
                <div className="tech-icon-box box-next">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 128 128"
              ...
              {/* Tailwind CSS */}
              <div className="tech-card">
                <div className="tech-icon-box box-tailwind">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 128 128"
          ...
          {/* Column 3: Backend */}
          <div className="tech-stack-column">
            <h4 className="tech-stack-header">Backend</h4>
            <div className="tech-grid">
              {/* Node.js */}
              <div className="tech-card">
                <div className="tech-icon-box box-node">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 128 128"
              ...
              {/* PostgreSQL */}
              <div className="tech-card">
                <div className="tech-icon-box box-postgres">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 128 128"
              ...
              {/* Laravel */}
              <div className="tech-card">
                <div className="tech-icon-box box-laravel">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
          ...
          {/* Column 4: DevOps & Herramientas */}
          <div className="tech-stack-column">
            <h4 className="tech-stack-header">Herramientas</h4>
            <div className="tech-grid">
              {/* AWS */}
              <div className="tech-card">
                <div className="tech-icon-box box-aws">
                  <svg
                    className="tech-svg"
                    viewBox="0 0 128 128"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              {/* Git */}
              <div className="tech-card">
                <div className="tech-icon-box box-git">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 128 128"
              ...
              {/* Claude */}
              <div className="tech-card">
                <div className="tech-icon-box box-claude">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
              ...
              {/* Codex */}
              <div className="tech-card">
                <div className="tech-icon-box box-codex">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                ...
                <span className="tech-name">Codex</span>
              </div>

              {/* Gemini */}
              <div className="tech-card">
                <div className="tech-icon-box box-gemini">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                  ...
                  >
                    <defs>
                      ...
                      >
                        ...
                        <stop offset="0.52" stopColor="#8B6CEF" />
                        <stop offset="1" stopColor="#D74FE0" />
                      </linearGradient>
                    </defs>
                    <path
                ...
                <span className="tech-name">Gemini</span>
              </div>

              {/* OpenCode */}
              <div className="tech-card">
                <div className="tech-icon-box box-opencode">
                  <svg
                    className="tech-svg"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                  ...
                  >
                    <path
                      fill="#00D4AA"
                      d="M3 4a2 2 0 012-2h14a2 2 0 012 2v16a2 2 0 01-2 2H5a2 2 0 01-2-2V4zm2-.5a.5.5 0 00-.5.5v16a.5.5 0 00.5.5h14a.5.5 0 00.5-.5V4a.5.5 0 00-.5-.5H5z"
                    />
                    <path
                      fill="#00D4AA"
                ...
                <span className="tech-name">OpenCode</span>
              </div>
            </div>
          </div>
        </div>
